[![img](http://pic.ex2tron.top/cv2_contrast_brightness.jpg)](http://pic.ex2tron.top/cv2_contrast_brightness.jpg)

# Python+OpenCV教程番外篇7：亮度与对比度

Posted on [December 10, 2017](http://ex2tron.wang/opencv-python-extra-contrast-brightness/)

学习如何调整图片的亮度和对比度。图片等可到[源码处](http://ex2tron.wang/opencv-python-extra-contrast-brightness/#%E5%BC%95%E7%94%A8)下载。
...
OpenCV中亮度和对比度应用这个公式来计算：g(x)=αf(x)+βg(x)=αf(x)+β，其中：α(>0)、β常称为增益与偏置值，分别控制图片的对比度和亮度。
...
[![亮度与对比度调整](http://pic.ex2tron.top/cv2_contrast_brightness.jpg)](http://pic.ex2tron.top/cv2_contrast_brightness.jpg)亮度与对比度调整
